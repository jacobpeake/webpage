      ...
      hoverTimeout = setTimeout(async () => {
        ...
        try {
          ...
          if (isWikipedia(url)) {
            ...
            let html = '';
            if (isRepo) {
              html = `<div class="preview-with-logo"><img src="https://github.githubassets.com/favicons/favicon.svg" alt=""><div class="preview-text"><div class="preview-title-row"><h3>${data.full_name || path}</h3><span class="preview-meta">${data.stargazers_count || 0} stars &nbsp;&nbsp; ${data.forks_count || 0} forks</span></div><p>${data.description || 'No description'}</p></div></div>`;
            } else {
