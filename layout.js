(function () {
  ...
  const social = [
    {
      label: 'GitHub',
      href: 'https://github.com/jacobpeake',
    ...
    {
      label: 'LinkedIn',
      href: 'https://www.linkedin.com/in/jacob-peake/',
  ...
  const writingPages = ['/how-to-learn.html', '/consciousness-is-unverifiable.html', '/nanoflash.html', '/msight.html'];
  function isWritingSubpage() { return writingPages.includes(path); }

  const projectPages = ['/gpu-explorer.html', '/nanoflash.html', '/msight.html'];
  function isProjectSubpage() { return projectPages.includes(path); }
  ...
  socialSection.className = 'sidebar-social';
  social.forEach(item => {
    const a = document.createElement('a');
